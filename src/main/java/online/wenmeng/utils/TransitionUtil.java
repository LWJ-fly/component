...
public class TransitionUtil {
     ...
     */
    public static Object transition(Object original, int code){
        switch (code){
            case 12:
                break;
            case 13:
            ...
            default:
                ...
                throw new RuntimeException("No corresponding conversion method is implemented(没有实现相应的转换方法)");
        }
        return "";
    }
    /*
     ...
     * @return 返回类型的标识
     */
    public static <T> int getClassType(Class<T> t){
         /*
            首先判断处理基本类型
